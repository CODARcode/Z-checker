...
ZC_DataProperty* ZC_genProperties_double(const char* varName, double *data, size_t numOfElem, size_t r5, size_t r4, size_t r3, size_t r2, size_t r1)
{
	...
	if(gradLenFlag)
	{
		double* gradLen_data = (double *)malloc(numOfElem*sizeof(double));
		memset(gradLen_data, 0, numOfElem*sizeof(double));		
		computeGradientLength_double(data, gradLen_data, r5, r4, r3, r2, r1);
		property->gradLen = gradLen_data;
	}
	
	if(sobolevNorm_s0_p2Flag)
		property->sobolevNorm_s0_p2 = calculateSobolevNorm_p2(data, ZC_DOUBLE, 0, r5, r4, r3, r2, r1);	
		
	if(sobolevNorm_s1_p2Flag)
		property->sobolevNorm_s1_p2 = calculateSobolevNorm_p2(data, ZC_DOUBLE, 1, r5, r4, r3, r2, r1);		
	
	if(sobolevNorm_s2_p2Flag)
		property->sobolevNorm_s2_p2 = calculateSobolevNorm_p2(data, ZC_DOUBLE, 2, r5, r4, r3, r2, r1);		
