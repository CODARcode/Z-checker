...
if [ ! -f report/z-checker-report.pdf ]; then
	...
	echo "Overleaf website: https://www.overleaf.com/ . How to upload zip file to create a new project in overleaf: https://www.youtube.com/watch?v=i22sF369bqA"
	echo "The latex package of the report can be found here: `pwd`/report/report.zip"
	exit
else
